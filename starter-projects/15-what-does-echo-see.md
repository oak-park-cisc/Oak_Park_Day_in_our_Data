...
- Cached in this repo: [echo-activity-oak-park.csv](../data/echo-activity-oak-park.csv) (aggregate counts of logged services, five small tables in long format keyed by `breakdown`: month by service category, month by referral source, weekday, four-hour time block, and referral source by service, February 2025 to September 2026; 494 rows)
- Cached in this repo: [crime-incidents-oak-park.csv](../data/crime-incidents-oak-park.csv) (for the stretch, used only as monthly counts by NIBRS category)
