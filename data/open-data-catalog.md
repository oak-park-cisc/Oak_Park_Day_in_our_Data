...
- **84 distinct resources** across **17 categories**
...
| **CTA ridership (L station daily entries, bus route monthly averages)** | Chicago Transit Authority via City of Chicago Data Portal | Daily turnstile entries per L station since 2001 and monthly weekday, Saturday, and Sunday averages per bus route since 2001; filter by station id or route. Cached for the seven Oak Park stations and seven routes, 2015 on, as `cta-ridership-oak-park.csv`. | [L station daily](https://data.cityofchicago.org/Transportation/CTA-Ridership-L-Station-Entries-Daily-Totals/5neh-572f) · [Bus route monthly](https://data.cityofchicago.org/Transportation/CTA-Ridership-Bus-Routes-Monthly-Day-Type-Averages/bynn-gwxy) · [List of L stops](https://data.cityofchicago.org/Transportation/CTA-System-Information-List-of-L-Stops/8pix-ypme) |
