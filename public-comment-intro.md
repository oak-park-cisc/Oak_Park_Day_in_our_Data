Hi I’m \_\_\_\_ from the Civic Information Systems Commission. As a commission we consult on the technology use of the Village, focusing on transparency, access, and creating positive outcomes for residents.

One of our core goals is to increase the amount of village data that’s available to the average citizen, and working with village staff, we’ve made good progress. But in order to create those positive outcomes, that data needs to be put to use.
